...
$(document).ready(function () {
  ...
  function setPagination() {
    ...
    var CreatePagers = (function () {
      var $isotopePager =
        $("." + pagerClass).length == 0
          ? $('<div class="' + pagerClass + ' paging"></div>')
          : $("." + pagerClass);
      ...
      if (currentNumberPages > 1) {
        for (var i = 0; i < currentNumberPages; i++) {
          ...
          if (currentPage == i + 1) {
            $pager = $(
              '<a href="javascript:void(0);" class="pager active paging-link" ' +
                pageAttribute +
                '="' +
                (i + 1) +
                '"></a>'
            ...
            $pager = $(
              '<a href="javascript:void(0);" class="pager paging-link" ' +
                pageAttribute +
                '="' +
                (i + 1) +
                '"></a>'
